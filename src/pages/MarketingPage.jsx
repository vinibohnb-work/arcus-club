...
const ALL_POSTS = [
  ...
  { id:"p4",  phase:1, week:"S02", date:"13/04", format:"Carrossel",   pilar:"Gestão de Times",             hook:"Conversa difícil adiada vira comportamento aceito. O time aprende o que o líder tolera" },
  { id:"p5",  phase:1, week:"S02", date:"15/04", format:"Estático",    pilar:"Mentalidade do Empreendedor", hook:"As decisões que você empurra para amanhã não desaparecem. Elas aparecem como cansaço no fim do dia" },
  { id:"p6",  phase:1, week:"S02", date:"17/04", format:"Reels",       pilar:"Liderança",                   hook:"Feedback dado tarde cobra juros. Quanto mais você espera, mais caro fica para todo mundo" },
  { id:"p7",  phase:1, week:"S03", date:"20/04", format:"Carrossel",   pilar:"Processos e Sistemas",        hook:"Se o time só se alinha quando você convoca uma reunião, o problema está antes da reunião" },
  { id:"p8",  phase:1, week:"S03", date:"22/04", format:"Estático",    pilar:"Visão e Estratégia",          hook:"Estratégia que todo mundo aprova numa quarta e ninguém executa numa quinta foi sabotada antes de começar" },
  ...
  { id:"p11", phase:1, week:"S04", date:"29/04", format:"Estático",    pilar:"Comunicação Interna",         hook:"Comunicação clara em liderança é uma escolha. Você decide o quanto quer ser entendido" },
  { id:"p12", phase:1, week:"S04", date:"01/05", format:"Reels",       pilar:"Gestão de Times",             hook:"Time que entrega o mínimo quase sempre tem alguém em cima que aceita o mínimo" },
  ...
  { id:"p14", phase:2, week:"S05", date:"06/05", format:"Estático",    pilar:"Processos e Sistemas",        hook:"Sair de férias e voltar para o mesmo caos é um sinal claro de que o processo ainda depende de você" },
  { id:"p15", phase:2, week:"S05", date:"08/05", format:"Reels",       pilar:"Cultura Organizacional",      hook:"Contratou pela competência. Demitiu pelo comportamento. O problema estava na seleção desde o início" },
  { id:"p16", phase:2, week:"S05", date:"09/05", format:"Bastidor",    pilar:"Arcus Club",                  hook:"Bastidor de encontro ou insight do programa" },
  { id:"p17", phase:2, week:"S06", date:"11/05", format:"Carrossel",   pilar:"Mentalidade do Empreendedor", hook:"O dia que você perceber que está resolvendo as mesmas questões de dois anos atrás é um bom dia para repensar como delega" },
  ...
  { id:"p19", phase:2, week:"S06", date:"15/05", format:"Reels",       pilar:"Visão e Estratégia",          hook:"Crescer rápido sem estrutura parece vitória no trimestre. No ano seguinte, o preço aparece" },
  ...
  { id:"p22", phase:2, week:"S07", date:"20/05", format:"Estático",    pilar:"Tomada de Decisão",           hook:"Cada decisão que vai para um comitê sai de lá mais lenta e com menos responsável claro" },
  ...
  { id:"p25", phase:2, week:"S08", date:"25/05", format:"Carrossel",   pilar:"Cultura Organizacional",      hook:"Os valores que a empresa anuncia e os comportamentos que ela recompensa são quase sempre listas diferentes" },
  { id:"p26", phase:2, week:"S08", date:"27/05", format:"Estático",    pilar:"Processos e Sistemas",        hook:"Empresa sem processo depende de quem tem mais energia no dia. Quando essa pessoa sai, tudo trava" },
  { id:"p27", phase:2, week:"S08", date:"29/05", format:"Reels",       pilar:"Mentalidade do Empreendedor", hook:"A maioria dos projetos morre no meio, não antes de começar. Terminar exige um sistema que começar não exige" },
  ...
  { id:"p30", phase:3, week:"S09", date:"03/06", format:"Estático",    pilar:"Cultura Organizacional",      hook:"Empresa que passa conhecimento só na conversa informal cresce até o dia que alguém sai" },
  { id:"p31", phase:3, week:"S09", date:"05/06", format:"Reels",       pilar:"Processos e Sistemas",        hook:"Dono que resolve o mesmo problema toda semana tem um processo que precisa de atenção" },
  ...
  { id:"p34", phase:3, week:"S10", date:"10/06", format:"Estático",    pilar:"Mentalidade do Empreendedor", hook:"Empreendedor que espera o crescimento resolver o caos interno vai esperar por muito tempo" },
  { id:"p35", phase:3, week:"S10", date:"12/06", format:"Reels",       pilar:"Visão e Estratégia",          hook:"Planejamento que fica na gaveta cumpriu a função de tranquilizar quem o fez. Mas não mudou nada" },
  ...
  { id:"p38", phase:3, week:"S11", date:"17/06", format:"Estático",    pilar:"Liderança",                   hook:"Autonomia sem estrutura gera paralisia. A pessoa não sabe onde começa e onde termina o espaço dela" },
  { id:"p39", phase:3, week:"S11", date:"19/06", format:"Reels",       pilar:"Cultura Organizacional",      hook:"Quando o clima do dia depende do humor de quem lidera, o time aprende a esperar antes de agir" },
  ...
  { id:"p41", phase:3, week:"S12", date:"22/06", format:"Carrossel",   pilar:"Processos e Sistemas",        hook:"Checklist que o time ignora quase sempre tem um problema antes da disciplina: o design está errado" },
  ...
  { id:"p43", phase:3, week:"S12", date:"26/06", format:"Reels",       pilar:"Gestão de Times",             hook:"Time que só se move quando o dono está presente aprendeu que esperar é mais seguro do que errar" },
  ...
  { id:"p46", phase:3, week:"S13", date:"01/07", format:"Estático",    pilar:"Mentalidade do Empreendedor", hook:"Proteger o próprio tempo começa com um sistema. Sem ele, qualquer urgência dos outros vira prioridade sua" },
